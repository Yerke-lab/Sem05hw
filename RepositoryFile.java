...
public class RepositoryFile implements Repository {
    ...
    public void saveOld() {
        ...
        fileOperation.saveAllLines(lines);
        System.out.println("Сохранено в старом формате");
    }
    ...
    public void saveNew() {
        ...
        List<String> lines = new ArrayList<>();
        for (User item : users) {
            lines.add(mapper.mapNew(item));
        }
        fileOperation.saveAllLines(lines);
        System.out.println("Сохранено в новом формате"); 
    }
